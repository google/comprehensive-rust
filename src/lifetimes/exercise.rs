...
fn main() {
    let person: Person = parse_message(&[
        0x0a, 0x07, 0x6d, 0x61, 0x78, 0x77, 0x65, 0x6c, 0x6c, 0x10, 0x2a, 0x1a, 0x1b, 0x0a, 0x0e,
        0x2b, 0x31, 0x32, 0x30, 0x32, 0x2d, 0x35, 0x35, 0x35, 0x2d, 0x31, 0x32, 0x31, 0x32, 0x12,
        0x04, 0x68, 0x6f, 0x6d, 0x65, 0x1d, 0xa4, 0x70, 0xbb, 0xc1, 0x1a, 0x1d, 0x0a, 0x0e, 0x2b,
        0x31, 0x38, 0x30, 0x30, 0x2d, 0x38, 0x36, 0x37, 0x2d, 0x35, 0x33, 0x30, 0x38, 0x12, 0x06,
        0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x1d, 0x9a, 0x99, 0x87, 0x42,
    ]);
    println!("{:#?}", person);
}
// ANCHOR_END: main
...
mod tests {
    ...
    fn test_phone() {
        let phone: Person = parse_message(&[
            0x1a, 0x1b, 0x0a, 0x0e, 0x2b, 0x31, 0x32, 0x33, 0x34, 0x2d, 0x37, 0x37, 0x37, 0x2d,
            0x39, 0x30, 0x39, 0x30, 0x12, 0x04, 0x68, 0x6f, 0x6d, 0x65, 0x1d, 0xa4, 0x70, 0xbb,
            0xc1,
        ]);
        assert_eq!(
            phone,
